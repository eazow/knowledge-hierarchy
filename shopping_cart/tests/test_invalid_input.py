...
"""
    ...
    assert total_price == "Invalid category"
...
"""
    total_price = Customer().shopping_and_settle(input_case2)
    assert total_price == "Invalid product name"
...
"""
    ...
    assert total_price == u"Invalid line: 2019.6.14 | 0.7a | 电子"
...
"""
    total_price = Customer().shopping_and_settle(input_case3)
    assert total_price == u"Invalid line: 啤酒"
